...
const AddUserForm = () => {
    ...
    return (
        ...
        >
            ...
            <button className="px-6 py-2 rounded-sm bg-green-500 text-white border hover:bg-gray-50 hover:border-green-500 hover:text-green-500 transition duration-500 w-1/3">
                Add
            </button>
        </form>
    );
